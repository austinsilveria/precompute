# Copied from https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_opt.py
#
# Modified to hook intermediate variables.
...
class HookedOPTForCausalLM(OPTPreTrainedModel):
